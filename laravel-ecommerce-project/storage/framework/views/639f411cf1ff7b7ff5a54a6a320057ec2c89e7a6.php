...
<?php $__env->startSection('content'); ?>
	...
	<div class="row">	  
            ...
            <a href="themes/images/products/large/f1.jpg" title="Fujifilm FinePix S2950 Digital Camera">
				<img src="<?php echo e(asset('uploads/'.$product->image)); ?>" style="width:100%" alt="Fujifilm FinePix S2950 Digital Camera"/>
            </a>
			...
			<div class="span6">
				<h3><?php echo e($product->ProductDetail->title); ?></h3>
				<hr class="soft"/>
				  <div class="control-group">
					<label class="control-label"><span>$<?php echo e($product->price); ?></span></label>
					<div class="controls">
						<form method="post" action="<?php echo e(route('cart.store')); ?>">
							...
							<?php else: ?>
								<button class="btn btn-large btn-primary pull-right"><a style="color: #fff;text-decoration: none;" href="<?php echo e(route('user_login')); ?>"> Add to cart <i class=" icon-shopping-cart"></i></a></button>
							<?php endif; ?>
						</form>
					</div>
				  </div>
				...
				<hr class="soft"/>
				<h4><?php echo e($product->ProductDetail->total_items); ?> items in stock</h4>
				...
				<hr class="soft clr"/>
				<p>
				<?php echo e($product->ProductDetail->description); ?>
		...
		<div class="tab-content">
			<div class="tab-pane active" id="blockView">
				<ul class="thumbnails">
					...
					<li class="span3">
					  <div class="thumbnail">
						<a href="product_details.html"><img src="<?php echo e(asset('uploads/'.$related_product->image)); ?>" alt=""/></a>
						<div class="caption">
						  <h5><?php echo e($related_product->name); ?></h5>
						  <h4 style="text-align:center"><a class="btn" href="product_details.html"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">&euro;<?php echo e($related_product->price); ?></a></h4>
						</div>
					  </div>
					</li>
...
<?php echo $__env->make('front.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel_pro\e_comm\customauthecomm\laravel-ecommerce-project\resources\views/front/productView.blade.php ENDPATH**/ ?>